				...
				<div class="col-xs-12 col-sm-8 col-md-6 col-sm-offset-2 col-md-offset-3">
					<?php
						...
						{				
							...
							$ressult_insert = mysqli_query($con,$sql);
							if($ressult_insert>0)
							{
								// print_r($sql);
								echo '<div class="alert alert-success"><a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a><strong>Success!</strong> Thank you for adding you as donor.</div>';
							}
							else
							{
