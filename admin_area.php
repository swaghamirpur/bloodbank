	...
	<div class="row">
		...
		<div class="col-sm-9" >
			...
			<div class="row">
				...
				<div class="col-md-6">
					<?php 
						$sql="Select state.STATE_NAME, city.CITY_NAME, area.AREA_NAME, area.AREA_ID From area Inner Join state On area.STATE_ID = state.STATE_ID Inner 
						Join city On area.CITY_ID = city.CITY_ID ORDER BY AREA_ID desc LIMIT 0,5";
						$result=$con->query($sql);
						if($result->num_rows>0)
						{
									...
									echo "<tr>
										...
										while($row=$result->fetch_assoc())
										{
											...
											echo"<tr>";
												...
												echo "<td><a href='admin_del_area.php?id=".$row["AREA_ID"]."' 
