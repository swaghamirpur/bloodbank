        ...
        <div class="container" style="margin-top:70px;">
            ...
            <div class="row">
                <div class="col-md-8">
                    <?php
                        if(isset($_POST["submit"]))
                        {
                            ...
                            if($con->query($sql))
                            {
                                echo '<div class="alert alert-success"><a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a><strong>Success!</strong> Your message has been Successfully sent.</div>';
                            }
                        }
                    ?>
                ...
                <div class="col-md-4">
                    ...
                    <p>
                        Blood Bank &amp; <br>Friend's Trust, <br>
                        34/44 ABC,<br>
                        XYZ - 144004 .<br>
                        INDIA.
                    </p>
